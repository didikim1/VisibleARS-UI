	 ...
	 <div class="contents">
			<div class="maincomment">
	      	...
	      	<div class="subcomment">
		     	 ARS인증은 본인이 요청한 것이 맞는지 보안강화를 위하여 진행하는 본인인증 단계입니다.
		     	 요청하지 않은 전화가 걸려 왔을경우 정보를 입력하지 않으시면 본인확인이 되지 않으므로 안심하셔도 됩니다.다만 계속해서 요청하지 않은 전화가 걸려 온다면 멘트에 안내되는 해당 고객사로 확인하시기 바랍니다.<br><br>
				 보다 자세한 사항은 인비즈넷 홈페이지를 통해 확인하시거나 상담원을 연결하시길 바랍니다.		     	 
	     	 </div>
	      	<div class="homePage">
