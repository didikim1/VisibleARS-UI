        ...
        <div class="container">
          <div class="row">
            <div class="col-4 col-xs-6 col-md-6">
              <img class="card-img-top" src="/ars/20211230/011.png" style="width: 100px;">
            </div>
        ...
        <div class="container mt-3">
          <div class="row">
            <div class="col-12 col-md-12 align-items-center pt-3">
              ARS인증 시 정상적으로 키패드를 입력하셨음에도 입력되지 않았다고 나오신다면 먼저 일시적인 통신 오류일 수 있어 이용하시는 <strong>휴대폰의 전원을 재부팅 후 ARS인증 재시도</strong> 해주시길 바랍니다. 그러나 재부팅 후에도 같은 현상일 시 아래 내용 참고하시어 이용해주시기 바랍니다.
            </div>
          </div>
        </div>
