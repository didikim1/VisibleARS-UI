	 ...
	 <div class="contents">
			<div class="maincomment">
	     	 ...
	     	 <div class="subcomment">
				ARS인증 시 정상적으로 인증번호를 입력하셨음에도 입력되지 않았다고 나오신다면, 보이는 ARS인증 화면 하단의 관련사항 먼저 참고하신 후 휴대폰 전원을 재부팅하여 이용해주시기 바랍니다. <br><br>
	
				1. 전화 받으신 화면에 키패드 입력 여부 확인<br>
				2. 수신 전화 화면 확인 (전화 걸려오는 화면이 스마트폰 상단에 팝업 형태로 뜨신다면, 팝업창 터치하여 전체 화면으로 변경 후 인증번호 입력)<br><br>
